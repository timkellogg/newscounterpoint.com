...
var Header = function () {
  function Header() {
    ...
    this.$el = (0, _jquery2.default)('.header');
  ...
  _createClass(Header, [{
    ...
    value: function bindListeners() {
      ...
      this.$trigger.click(function (event) {
        _this.$el.toggleClass('header--open');
        _this.$hamburger.toggleClass('header__hamburger--active');
        _this.$menu.toggle();
      });
    }
  }]);
